        ...
        with col_left:
            ...
            with st.form(key="settings_form"):
                ...
                groq_model_input = st.selectbox(
                    ...
                    index=groq_model_options.index(db_groq_model) if db_groq_model in groq_model_options else 0,
                    format_func=lambda m: groq_model_labels.get(m, m),
                    help="Select your Groq model. Use 'llama-3.1-8b-instant' if you want to avoid 429 rate limit issues completely."
                )
